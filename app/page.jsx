...
const T = {
  ...
  border:"#141438", borderHi:"#1E1E50", text:"#E8E8FF", sub:"#9090CC", muted:"#44447A", dim:"#0F0F30",
  high:"#FF3344", highDim:"#FF334415", highMid:"#FF334433",
  med:"#FFB800", medDim:"#FFB80015",
  low:"#00C896", lowDim:"#00C89615",
  us:"#4488FF", usDim:"#4488FF15", india:"#FF9933", indiaDim:"#FF993315",
  eu:"#66AAFF", euDim:"#66AAFF15", uk:"#EE4466", ukDim:"#EE446615",
  me:"#FFD700", meDim:"#FFD70015", asia:"#FF6633", asiaDim:"#FF663315",
  africa:"#88CC44", africaDim:"#88CC4415", latam:"#FF44AA", latamDim:"#FF44AA15",
  rumored:"#6655AA", filed:"#4488FF", confidential:"#AA55FF", roadshow:"#FF9933",
  pricing:"#FFD000", live:"#FF3344", listed:"#00C896",
  ipo:"#4488FF", spac:"#AA55FF", direct:"#00C896", spinoff:"#FF9933", secondary:"#FF6633",
  green:"#00FFB3", gold:"#FFD000", cyan:"#00E5FF", purple:"#AA55FF", sec:"#FF3344",
};
...
const STAGES = [
  { id:"Rumored", color:T.rumored, icon:"💭", tip:"Market intelligence" },
  { id:"Confidential", color:T.confidential, icon:"🔒", tip:"Confidential filing" },
  { id:"Filed", color:T.filed, icon:"📋", tip:"Official filing" },
  { id:"Amended", color:T.purple, icon:"📝", tip:"Filing updated" },
  ...
  return (
    <div style={{position: "fixed", inset: 0, background: "#000000DD", zIndex: 300, display: "flex", alignItems: "center", justifyContent: "center", padding: 12}} onClick={onClose}>
      <div style={{background: T.card, border: `1px solid ${T.borderHi}`, borderLeft: `4px solid ${imp.color}`, borderRadius: 20, width: "100%", maxWidth: 580, maxHeight: "90vh", overflowY: "auto", padding: 22}} onClick={e => e.stopPropagation()}>
        ...
        <div style={{display: "flex", gap: 8, flexWrap: "wrap"}}>
          {item.edgarLink && <a href={item.edgarLink} target="_blank" rel="noreferrer" style={{flex: 1, minWidth: 120, padding: "10px", borderRadius: 12, background: T.usDim, border: `1px solid ${T.us}44`, color: T.us, fontSize: 12, fontWeight: 700, textAlign: "center", textDecoration: "non  { id:"us",     flag:"🇺🇸", label:"Americas/SEC", color:T.us },
  { id:"india",  flag:"🇮🇳", label:"India/SEBI",  color:T.india },
  { id:"eu",     flag:"🇪🇺", label:"Europe",      color:T.eu },
  { id:"uk",     flag:"🇬🇧", label:"UK/LSE",      color:T.uk },
  { id:"me",     flag:"🌙", label:"Middle East",  color:T.me },
